	...
	return (
		<>
			<div style={styles.page}>
				...
				<img style={styles.fullWidth} src="photo-2.png" alt=""/> */}
			</div>
			...
			<div style={styles.page}>
				...
				<div style={styles.columnLayout}>
					...
					<div style={styles.column}>
						{/* <img style={styles.fullWidth} src="photo-1.png" alt=""/> */}
				...
				<div style={styles.columnLayout}>
					<div style={styles.column}>
						{/* <img style={styles.fullWidth} src="photo-3.png" alt=""/> */}
						<h4 style={styles.marginb0}>Subtitle One</h4>
						<p>
							Lorem ipsum dolor sit amet, consectetur adipiscing
							elit, sed do eiusmod tempor incididunt ut labore et
					...
					<div style={styles.column}>
						{/* <img style={styles.fullWidth} src="photo-4.png" alt=""/> */}
						<h4 style={styles.marginb0}>Subtitle Two</h4>
						<p>
							Lorem ipsum dolor sit amet, consectetur adipiscing
							elit, sed do eiusmod tempor incididunt ut labore et
