...
const addStylesToWorksheet = (worksheet, data) => {
...
const exportDataToXlsx = (headers, data) => {
	...
	addStylesToWorksheet(worksheet, data)
...
export const ExportTableInXlsx = () => {
	...
	return (
		<div>
			<button onClick={e => { execute() }}>Descargar reporte en formato tabla en excel (xlsx) </button>
		</div>
	)
}